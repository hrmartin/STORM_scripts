...
class NN():
    ...
    def load_and_cluster_data(self, filename):
        ...
        if len(coords) < 100000:
            print("Error: too few data points to cluster")
    ...
    def db_scan(self, coords):
        ...
        #print(len(coord_labels))
        print(len(cluster_labels))
        #print(len(cluster_center_mass))
                   #print(len(coord_labels))
        #print(len(cluster_labels))
        
        print("Length of coord_labels after dbscan assigned coord_labels: " + str(len(coord_labels)))
        print("coord_label at i = 5: " + str(coord_label[5]) + "; at i = 15: " + str(coord_label[15]) + "; at i = 335: " + str(len(coord_label[335]))

        #print("length of unique elements in coord_labels: " + str(len(np.unique(coord_labels))))
